...
@section('content')
    ...
    <section class="section section-sm">
        <div class="container">
            <h3>Rekap Transaksi Travel</h3>
            <div class="row">
                @foreach ($transaction as $item)
                    <div class="col-sm-4 mt-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">{{ $item->travel->name }}</h5>
                                <p class="card-text">{{ $item->travel->harga }}</p>
                                ...
                                <a href="{{ url('user/transaction/edit_travel/' . $item->id ) }}" class="btn btn-primary">Detail</a>
                            </div>
                        </div>
                    </div>
                @endforeach
