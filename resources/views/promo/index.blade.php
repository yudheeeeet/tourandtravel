...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h3 class="mt-4">Konten Travel Promo</h3>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <a href="{{ url('/promo/data/create') }}" class="btn btn-primary">Tambah Data Baru</a>
                </div>
                <div class="card-header">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->harga }}</td>
                                <td>
                                    <a href="{{ url('/promo/data' . '/' . $item->id . '/edit') }}"
                                        class="btn btn-warning">Edit</a>
                                        <form action="{{ url('/promo/data' . '/' . $item->id) }}" method="POST">
                                            @csrf
