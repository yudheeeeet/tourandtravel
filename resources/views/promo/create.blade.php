        ...
        <div class="container-fluid px-4">
            <div class="col-md-12">
                <div class="card-body" style="text-align: left;">
                    <h3 class="mb-3">Tambah Data Travel Promo</h3>
                    @error('foto')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    <form action="/promo/data" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon3">Nama Promo</span>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"  name="jumlah" required>
                        </div>
                        
                        <div class="input-group mb">
                            <span class="input-group-text" id="basic-addon5">Deadline</span>
                            <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="deadline" required>
                        </div>
